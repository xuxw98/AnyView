...
def adjust_learning_rate(args, optimizer, curr_epoch):
    ...
    for i, param_group in enumerate(optimizer.param_groups):
        if i < num_groups // 2:
            ...
            param_group["lr"] = curr_lr * args.image_lr / args.base_lr
    return curr_lr
...
def train_one_epoch(
    ...
    for batch_idx, batch_data_label in enumerate(dataset_loader):
        ...
        if "sepview" in args.model_name:
            inputs["pcs"] = batch_data_label["pcs"]
            inputs["trans"] = batch_data_label["trans"]
        if args.use_image:
            inputs["images"] = batch_data_label["images"]
            inputs["view_mask"] = batch_data_label["view_mask"]
            inputs["point_cloud_inds"] = batch_data_label["point_cloud_inds"]
