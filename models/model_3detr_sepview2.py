...
class Model3DETR_SepView(nn.Module):
    ...
    def run_encoder(self, point_clouds, trans, point_cloud_dims):
        ...
        pre_enc_xyz, pre_enc_features, _ = self.pre_encoder[0](xyz, features)

        # nn.MultiHeadAttention in encoder expects npoints x batch x channel features
        pre_enc_features = pre_enc_features.permute(2, 0, 1)
        pre_enc_xyz, pre_enc_features, _ = self.pre_encoder[1](
        ...
        pre_enc_features = pre_enc_features.view(PPF, B, T, -1).transpose(1,2).contiguous().view(PPF*T, B, -1)
...
def build_preencoder(args):
    ...
    preencoder2_layer = TransformerEncoderLayer(
    ...
    preencoder2 = TransformerEncoder(
        encoder_layer=preencoder2_layer, num_layers=1
    )
