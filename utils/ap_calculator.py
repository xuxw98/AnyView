...
def parse_predictions(
    predicted_boxes, sem_cls_probs, objectness_probs, point_cloud, config_dict, return_pred_mask=False
):
...
class APCalculator(object):
    ...
    def step_meter_pred_mask(self, outputs, targets):
        if "outputs" in outputs:
            outputs = outputs["outputs"]
        return self.step_pred_mask(
            predicted_box_corners=outputs["box_corners"],
            sem_cls_probs=outputs["sem_cls_prob"],
            objectness_probs=outputs["objectness_prob"],
            point_cloud=targets["point_clouds"],
    ...
    def step_pred_mask(
        ...
        pred_mask = parse_predictions(
            predicted_box_corners,
            sem_cls_probs,
            objectness_probs,
            point_cloud,
            self.ap_config_dict,
            return_pred_mask=True
        )
        return pred_mask
